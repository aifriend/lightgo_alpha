...
SCORES_CSV_PATH = "./train/scores.csv"
SCORES_PNG_PATH = "./train/scores.png"
SOLVED_CSV_PATH = "./train/solved.csv"
SOLVED_PNG_PATH = "./train/solved.png"
AVERAGE_SCORE_TO_SOLVE = 10
CONSECUTIVE_RUNS_TO_SOLVE = 10


class ScoreLogger:
    ENV_NAME = "LightHouse_go"
    ...
    def add_score(self, score, run):
        ...
        print("Scores: (min: " + str(min(self.scores)) + ", avg: " + str(mean_score) + ", max: " + str(
            max(self.scores)) + ")\n")
